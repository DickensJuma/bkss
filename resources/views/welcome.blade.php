...
<div class="bg-img-hero"
    ...
    <div id="booking" class="section top-section">
        <div class="container">
        ...
        <div class="theme-carousel">
            <div class="owl-carousel owl-theme owl-listing">
                <div class="item">
                    ...
                    <div class="card">
                        <div class="card-img">
                            <a href="pages/list-single.html"> <img
                                    src="{{asset('front/assets/images/listing-img-1.jpg')}}" alt=""
                                    class="img-fluid rounded-top"></a>
                            <div class="btn-wishlist"></div>
                        </div>
                        <div class="card-body">
                            <div class="">
                                <h3 class="h4"> <a href="pages/list-single.html" class="text-dark">Beautiful Cozy
                                        Home</a></h3>
                                <p class="text-sm font-weight-semi-bold"><i class="mdi mdi-map-marker mr-1"></i>London .
                                    Apartment</p>
                            </div>
                            <div class="d-flex justify-content-between">
                                <div class="">
                                    <span class="text-dark h5">$100</span><span
                                        class="text-sm font-weight-semi-bold ml-1">/night</span>
                                </div>
                                <div class="">
                ...
                <div class="item">
                    ...
                    <div class="card">
                        <div class="card-img">
                            <a href="pages/list-single.html"> <img
                                    src="{{asset('front/assets/images/listing-img-2.jpg')}}" alt=""
                                    class="img-fluid rounded-top"></a>
                            <div class="btn-wishlist"></div>
                        </div>
                        <div class="card-body">
                            <div class="">
                                <h3 class="h4"> <a href="pages/list-single.html" class="text-dark">Affordable Long Term
                                        Room</a></h3>
                                <p class="text-sm font-weight-semi-bold"><i class="mdi mdi-map-marker mr-1"></i>Madrid .
                                    Private Room</p>
                            </div>
                            <div class="d-flex justify-content-between">
                                <div class="">
                                    <span class="text-dark h5">$250</span><span
                                        class="text-sm font-weight-semi-bold ml-1">/night</span>
                                </div>
                                <div class="">
                                    <span class="mdi mdi-star mr-1 text-warning text-sm"></span>
                ...
                <div class="item">
                    ...
                    <div class="card">
                        <div class="card-img">
                            <a href="pages/list-single.html"> <img
                                    src="{{asset('front/assets/images/listing-img-3.jpg')}}" alt=""
                                    class="img-fluid rounded-top"></a>
                            <div class="btn-wishlist"></div>
                        </div>
                        <div class="card-body">
                            <div class="">
                                <h3 class="h4"> <a href="pages/list-single.html" class="text-dark">Entire 3 BHK Cozy
                                        Apartment</a></h3>
                                <p class="text-sm font-weight-semi-bold"><i class="mdi mdi-map-marker mr-1"></i>New York
                                    . Apartment</p>
                            </div>
                            <div class="d-flex justify-content-between">
                                <div class="">
                                    <span class="text-dark h5">$180</span><span
                                        class="text-sm font-weight-semi-bold ml-1">/night</span>
                                </div>
                                <div class="">
                                    <span class="mdi mdi-star mr-1 text-warning text-sm"></span>
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                <div class="media">
                    ...
                    <div class="media-content">
                        ...
                        <p>Morbi elit sem iaculis quis blandit onewse necpulvinar vitae lectus one enean suultricesut.
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                <div class="media">
                    ...
                    <div class="media-content">
                        ...
                        <p>Vestibulum auctor mximus estquinia vulputate etesd phasellus fermede ntum utodio aliquam
                            laoreete. </p>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                <div class="media">
                    ...
                    <div class="media-content">
                        ...
                        <p>Phasellus pulvinar volutpat justoquispose suere ested lorem ipsume volutpat dui id nulla
                            perdietin. </p>
                    </div>
                </div>
            </div>
            ...
            <div class="owl-carousel owl-theme owl-testimonial">
                <div class="item">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="mb-4 text-dark">Nam risus dui consequatet magna vitae blandit hendrerit
                                risustesque ante varius iaculis feugiat nulla metustiam auctor malesuada.</p>
                            <div class="d-flex justify-content-between">
                ...
                <div class="item">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h3 class="h4 mb-2">It was absolutely lovely</h3>
                            <p class="mb-4 text-dark">Vivamus vel imperdiet purus ante id fermentum libero luctus sit
                                ametonec dictum risus vitaenicuus acese mollis dolor porttitort convvariun.</p>
                            <div class="d-flex justify-content-between">
                                <div class="text-warning align-self-center text-sm">
                                    <span class="mdi mdi-star"></span>
                                    <span class="mdi mdi-star"></span>
                                ...
                                <div class="media align-items-center">
                                    <img src="{{asset('front/assets/images/avatar-2.jpg')}}" alt=""
                                        class="avatar-xs rounded-circle mr-2">
                ...
                <div class="item">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="mb-4 text-dark">Sollicitudin purus ante id fermentum libero luctusivamus vel
                                imperdiet eniroin sit ametonec dictum mollis dolor porttitort convvariun.</p>
                            <div class="d-flex justify-content-between">
                                <div class="text-warning align-self-center text-sm">
                                    <span class="mdi mdi-star"></span>
                                    <span class="mdi mdi-star"></span>
                                ...
                                <div class="media align-items-center">
                                    <img src="{{asset('front/assets/images/avatar-3.jpg')}}" alt=""
                                        class="avatar-xs rounded-circle mr-2">
                                    <span class="text-sm text-dark font-weight-semi-bold">Richard Jason</span>
                                </div>
                            </div>
                ...
                <div class="item">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h3 class="h4 mb-2">It was absolutely lovely</h3>
                            <p class="mb-4 text-dark">Nam risus dui consequatet magna vitae blandit hendrerit
                                risustesque ante varius iaculis nibh ieuismod auctor malesuada.</p>
                            <div class="d-flex justify-content-between">
                                <div class="text-warning align-self-center text-sm">
                                    <span class="mdi mdi-star"></span>
                                    <span class="mdi mdi-star"></span>
                ...
                <div class="item">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h3 class="h4 mb-2">It was absolutely lovely</h3>
                            <p class="mb-4 text-dark">Vivamus vel imperdiet ante id fermentum libero luctus sit ametonec
                                dictum risus vitaenicuus acese mollis dolor porttitort convvariun.</p>
                            <div class="d-flex justify-content-between">
                                <div class="text-warning align-self-center text-sm">
                                    <span class="mdi mdi-star"></span>
                                    <span class="mdi mdi-star"></span>
                ...
                <div class="item">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h3 class="h4 mb-2">Had an amazing time</h3>
                            <p class="mb-4 text-dark">Sollicitudin purus luctusivamus vel imperdiet eniroin sit ametonec
                                dictum risus vitaenicuus acese mollis dolor porttitort convvariun.</p>
                            <div class="d-flex justify-content-between">
                                <div class="text-warning align-self-center text-sm">
                                    <span class="mdi mdi-star"></span>
                                ...
                                <div class="media align-items-center">
                                    <img src="{{asset('front/assets/images/avatar-3.jpg')}}" alt=""
                                        class="avatar-xs rounded-circle mr-2 img-fluid">
                                    <span class="text-sm text-dark font-weight-semi-bold">Richard Jason</span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="item">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h3 class="h4 mb-2">It was absolutely lovely</h3>
                            <p class="mb-4 text-dark">Nam risus dui consequatet risustesque ante varius iaculis nibh
                                ieuismod leouce feugiat nulla metustiam auctor malesuada.</p>
                            <div class="d-flex justify-content-between">
                                <div class="text-warning align-self-center text-sm">
                                    <span class="mdi mdi-star"></span>
                                    <span class="mdi mdi-star"></span>
                                ...
                                <div class="media align-items-center">
                                    <img src="{{asset('front/assets/images/avatar-1.jpg')}}" alt=""
                                        class="img-fluid avatar-xs rounded-circle mr-2">
                                    <span class="text-sm text-dark font-weight-semi-bold">James Duncan</span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="item">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h3 class="h4 mb-2">It was absolutely lovely</h3>
                            <p class="mb-4 text-dark">Vivamus vel imperdiet eniroin sollicitudin purus ante id fermentum
                                libero luctus sit ametonec dictum porttitort convvariun.</p>
                            <div class="d-flex justify-content-between">
                                <div class="text-warning align-self-center text-sm">
                                    <span class="mdi mdi-star"></span>
                                    <span class="mdi mdi-star"></span>
                ...
                <div class="item">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h3 class="h4 mb-2">Had an amazing time</h3>
                            <p class="mb-4 text-dark">Sollicitudin purus ante id fermentum libero luctusivamus vel
                                imperdiet eniroin sit ametonec dictum risus vitaenicuus acese mollis dolor porttitort
                                convvariun.</p>
                            <div class="d-flex justify-content-between">
                                <div class="text-warning align-self-center text-sm">
                                    <span class="mdi mdi-star"></span>
        ...
        <div class="row">
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                <div class="card mb-3">
                    <!-- post classic block -->
                    <div class="card-img">
                        <a href="blog/blog-single.html"><img src="{{asset('front/assets/images/post-thumb-img-1.jpg')}}"
                                alt="" class="img-fluid rounded-top"></a>
                    </div>
                    <div class="card-body">
                        ...
                        <h4 class="h5"><a href="blog/blog-single.html" class="text-dark">How To Get People To Like
                                Rental </a></h4>
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                <div class="card mb-3">
                    <!-- post classic block -->
                    <div class="card-img">
                        <a href="blog/blog-single.html"><img src="{{asset('front/assets/images/post-thumb-img-2.jpg')}}"
                                alt="" class="img-fluid rounded-top"></a>
                    </div>
                    <div class="card-body">
                        <div class="text-xs mb-2 ">
                        ...
                        <h4 class="h5"><a href="blog/blog-single.html" class="text-dark">The 8 Best Things to Do Indoors
                                in Delhi</a></h4>
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                <div class="card mb-3">
                    <!-- post classic block -->
                    <div class="card-img">
                        <a href="blog/blog-single.html"><img src="{{asset('front/assets/images/post-thumb-img-3.jpg')}}"
                                alt="" class="img-fluid rounded-top"></a>
                    </div>
                    <div class="card-body">
                        <div class="text-xs mb-2 ">
                        ...
                        <h4 class="h5"><a href="blog/blog-single.html" class="text-dark"> 5 Simple Ways to Experience
                                Rentkit for Next Webproject</a></h4>
        ...
        <div class="row d-flex justify-content-between">
            <div class="col-xl-9 col-lg-9 col-md-8 col-sm-12 col-12">
                <div class="mb-2">
                    ...
                    <p class="text-white mb-0">Fusce ut varius estfacilisis tellusecenas ornare suscipit justsed dapibus
                        ante.</p>
                </div>
            </div>
